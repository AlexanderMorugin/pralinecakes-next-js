...
import { CategoryButton, LinkButton } from '@/entities';
import Routes from '@/shared/constants/routes';
import { PAGE_CATEGORIES_LINK } from '@/shared/constants/pages';
...
export const CategoryBlock: FC<ICategoryBlock> = ({ category }) => {
