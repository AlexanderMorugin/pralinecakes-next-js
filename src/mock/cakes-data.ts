...
export const cakesData = [
  ...
  },
  {
    ...
    description:
      ...
      descriptionSecond: 'Торт шедевр и его обязательно нужно попробовать! Своим мощным медовым вкусом, он готов поспорить с любым самым изысканным "Медовиком". Один из лучших тортов наших кондитеров!',
      condition:
