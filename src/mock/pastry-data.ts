...
export const pastryData = [
  ...
  },
  {
    ...
    title: 'Эстерхази',
    description:
      'Пирожное приготовлено из нескольких коржей, отпеченных из ореховой муки, прослоенных нежным сливочным кремом с добавлением ореховой пасты "Пралине", сгущенного молока, лесных орехов, миндаля и арахиса. Сверху десерт покрыт белой шоколадной глазурью, под которой расположен слой абрикосового джема. Вкус очень интересный, ореховый, сочный и его хочется есть снова и снова. Пирожное безусловно понравится покупателям! Рекомендуем.',
    condition:
    ...
    ingredients:
      'Ореховая мука, фундук, арахис, миндаль, сахар, масло сливочное, яйцо куриное, масло растительное, белый и темный шоколад, сгущенное молоко, ореховая паста, джем абрикосовый',
    protein: 9.1,
    fat: 38.2,
    carbohydrates: 33.2,
    calories: 492,
