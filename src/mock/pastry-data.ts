...
import { esterhazyStoryForPastry, napoleonStoryForPastry } from './stories';
...
export const pastryData = [
  ...
  },
  {
    ...
    title: 'Миндальное',
    description:
      'Миндальное пирожное выполнено из орехово-мучных коржей, между которыми расположена начинка из нежного сливочного крема с молотым грецким орехом и кусочками чернослива. Вкус десерта очень приятный, ореховый, плотный, вязкий. Пирожное ощущается очень калорийным и маленького кусочка достаточно чтобы насытится с ароматной чашечкой кофе. Сверху пирожное украшено сахарной пудрой и лепестками обжаренного миндаля. Этот десерт пользуется большой популярностью у клиентов нашей кондитерской.',
    condition:
  ...
  },
  {
    ...
    title: 'Муравейник',
    description:
      'Оригинальное необычное пирожное выполненное в виде маленького муравейника. Выполнено из кусочков песочного печенья, которые замешаны с плотным кремом из вареного сгущенного молока. На вкус пирожное весьма интересное и вкусное, хоть по своему составу совсем простое.',
    condition:
      'Десерт можно купить по оптовой цене для дальнейшей реализации в кофейнях. Поставляется в замороженном виде. С правилами хранения замороженных пирожных знакомьтесь переходя по ссылке ниже.',
    ingredients:
  ...
  },
  {
    ...
    description:
      'Одно из самых вкусных пирожных нашей кондитерской! Нежнейшие, сочные, шоколадные коржи бисквита пропитанные медом и сгущенным молоком, с прослойками из мягкого, сливочного крема белоснежного цвета. В крем замешан арахис, который дополняет очаровательную мягкость десерта своим похрустыванием. Сверху пирожное украшено какао.',
    condition:
      'Пирожное является кусочком большого торта, увидеть который можно перейдя по ссылке на картинке. Готовится специально для кафе и ресторанов, купить которое можно по демократичной оптовой цене. Поставляется замороженным. Имеет два вида фасовки по 60 и 90 грамм. Рекомендуем!',
    ingredients:
      'Сгущенное молоко, сахар, сливки, арахис, мед, масло сливочное, яйцо куриное, мука пшеничная, сода, какао',
    protein: 7,
    fat: 22,
    carbohydrates: 45.8,
    calories: 414,
