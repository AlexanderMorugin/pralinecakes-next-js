...
export const cakesData = [
  ...
  },
  {
    ...
    title: 'Эстерхази',
    description:
      'Весьма известный ореховый торт, приготовленный из нескольких коржей с прослойкой из сливочного крема, ореховой пасты, сгущенного молока, фундука, арахиса и миндаля. Сверху торт покрыт абрикосовым джемом и глазурью из темного и белого шоколада. Торт пользуется большой популярностью за свой мягкий орехово-кремовый вкус.',
    condition:
